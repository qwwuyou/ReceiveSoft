...
namespace Service
{
    ...
    { 
        ...
        public System.Data.DataTable GetManualDataForWhere(string Where)
        {
            ...
            if (Where == "") { Where = " where rownum<=100"; }
            else { Where =Where.Replace("order" ," and rownum<=100 order"); }
        ...
        {
            return dt.Select<YY_DATA_IMG>("YY_DATA_IMG", new string[] { "*" }, " where STCD='" + STCD + "' and TM =to_date('" + TM + "','yyyy-MM-dd HH24:MI:SS')");
        }
        ...
        {
            string name = "(SELECT  STCD, ItemID, TM, DOWNDATE, NFOINDEX, DATAVALUE,CorrectionVALUE, DATATYPE FROM  YY_DATA_AUTO where rownum<=100  ORDER BY TM DESC)  yda LEFT OUTER JOIN YY_RTU_Basic ON yda.STCD = YY_RTU_Basic.STCD LEFT OUTER JOIN YY_RTU_ITEM ON yda.ItemID = YY_RTU_ITEM.ItemID";
        ...
        {
            string name = "(SELECT   STCD, ItemID, TM, DOWNDATE, NFOINDEX, DATAVALUE,CorrectionVALUE, DATATYPE FROM  YY_DATA_AUTO  " + Where + " and rownum<=100  ORDER BY TM DESC) yda LEFT OUTER JOIN YY_RTU_Basic ON yda.STCD = YY_RTU_Basic.STCD LEFT OUTER JOIN YY_RTU_ITEM ON yda.ItemID = YY_RTU_ITEM.ItemID";
            string[] fields = new string[] { "yda.TM, YY_RTU_Basic.STCD,yda.CorrectionVALUE, YY_RTU_Basic.NiceName, YY_RTU_ITEM.ItemID, YY_RTU_ITEM.ItemName, YY_RTU_ITEM.ItemDecimal,YY_RTU_ITEM.PlusOrMinus, yda.DOWNDATE, yda.NFOINDEX, yda.DATAVALUE, yda.DATATYPE" };
            string where = "order by yda.TM DESC";
            return dt.Select(name, fields, where);
        }
        ...
        {
            string name = "(SELECT  STCD, ItemID, TM, DOWNDATE, NFOINDEX, DATAVALUE, DATATYPE FROM YY_DATA_REM " + Where + " and rownum<=100 ORDER BY TM DESC)  ydr LEFT OUTER JOIN YY_RTU_ITEM ON ydr.ItemID = YY_RTU_ITEM.ItemID LEFT OUTER JOIN YY_RTU_Basic ON ydr.STCD = YY_RTU_Basic.STCD ";
        ...
        {
            string name = "(SELECT   STCD, ItemID, TM, DOWNDATE, NFOINDEX, DATAVALUE,CorrectionVALUE, DATATYPE FROM  YY_DATA_AUTO  where rownum<=100 and stcd='" + STCD + "' ORDER BY TM DESC)  yda LEFT OUTER JOIN YY_RTU_Basic ON yda.STCD = YY_RTU_Basic.STCD LEFT OUTER JOIN YY_RTU_ITEM ON yda.ItemID = YY_RTU_ITEM.ItemID";
            string[] fields = new string[] { "yda.TM, YY_RTU_Basic.STCD,yda.CorrectionVALUE, YY_RTU_Basic.NiceName, YY_RTU_ITEM.ItemID, YY_RTU_ITEM.ItemName, YY_RTU_ITEM.ItemDecimal,YY_RTU_ITEM.PlusOrMinus, yda.DOWNDATE, yda.NFOINDEX, yda.DATAVALUE, yda.DATATYPE" };
            string where = "order by yda.TM DESC";
            return dt.Select(name, fields, where);
        }
        ...
        public System.Data.DataTable GetRealTimeData(string STCD, string[] ItemIDs)  //**********
        {
            ...
            string name = "(SELECT  STCD, ItemID, TM, DOWNDATE, NFOINDEX, DATAVALUE,CorrectionVALUE, DATATYPE FROM  YY_DATA_AUTO  where rownum<=100 and stcd='" + STCD + "' and ItemID in(" + itemids + ") ORDER BY TM DESC) yda LEFT OUTER JOIN YY_RTU_Basic ON yda.STCD = YY_RTU_Basic.STCD LEFT OUTER JOIN YY_RTU_ITEM ON yda.ItemID = YY_RTU_ITEM.ItemID";
            string[] fields = new string[] { "yda.TM, YY_RTU_Basic.STCD,yda.CorrectionVALUE, YY_RTU_Basic.NiceName, YY_RTU_ITEM.ItemID, YY_RTU_ITEM.ItemName, YY_RTU_ITEM.ItemDecimal,YY_RTU_ITEM.PlusOrMinus, yda.DOWNDATE, yda.NFOINDEX, yda.DATAVALUE, yda.DATATYPE" };
            string where = "order by yda.TM DESC";
            return dt.Select(name, fields, where);
        }
        ...
        public System.Data.DataTable GetRealTimeNewData(string[] ItemIDs)
        {
           ...
           "from (SELECT STCD, ItemID, MAX(TM) AS TM FROM YY_DATA_AUTO GROUP BY STCD, ItemID) ttt LEFT OUTER JOIN YY_DATA_AUTO ON ttt.STCD = YY_DATA_AUTO.STCD AND ttt.ItemID = YY_DATA_AUTO.ItemID ";
            ...
            "FROM nt    " +
            "LEFT OUTER JOIN YY_RTU_ITEM ON nt.ItemID = YY_RTU_ITEM.ItemID RIGHT OUTER JOIN YY_RTU_Basic ON nt.STCD = YY_RTU_Basic.STCD    " +
            " where  nt.ItemID in (" + itemids + ") order by YY_RTU_Basic.STCD,nt.ItemID  ";
        ...
        public System.Data.DataTable GetRealTimeNewData(string[] ItemIDs, string STTYPE)
        {
          ...
          "from (SELECT STCD, ItemID, MAX(TM) AS TM FROM YY_DATA_AUTO GROUP BY STCD, ItemID) ttt LEFT OUTER JOIN YY_DATA_AUTO ON ttt.STCD = YY_DATA_AUTO.STCD AND ttt.ItemID = YY_DATA_AUTO.ItemID ";
            ...
            "FROM nt    " +
            "LEFT OUTER JOIN YY_RTU_ITEM ON nt.ItemID = YY_RTU_ITEM.ItemID RIGHT OUTER JOIN YY_RTU_Basic ON nt.STCD = YY_RTU_Basic.STCD    " +
            " where  nt.ItemID in (" + itemids + ")  and sttype ='" + STTYPE + "' order by YY_RTU_Basic.STCD,nt.ItemID  ";
        ...
        public System.Data.DataTable GetRTUState(string STCD)
        {
            ...
            string where = "where rownum<=100 and YY_RTU_Basic.STCD='" + STCD + "' ORDER BY YY_DATA_STATE.TM DESC";
            return dt.Select(name, fields, where);
        }
