...
namespace Service
{
    public class SqlDBBussiness : DBBussiness 
    {
        

        public _51Data dt = null;
        public SqlDBBussiness()
        {
            dt = new _51Data();
        }
        public SqlDBBussiness(string Path)
        { 
            dt = new _51Data(Path);
        }
        ...
        public System.Data.DataTable GetManualDataForWhere(string Where)
        {
            ...
            string[] fields = new string[] { "TOP 100 YY_RTU_Basic.STCD, YY_RTU_Basic.NiceName, YY_DATA_MANUAL.DOWNDATE, YY_DATA_MANUAL.NFOINDEX,YY_DATA_MANUAL.DATAVALUE, YY_DATA_MANUAL.DATATYPE,YY_DATA_MANUAL.TM" };
        ...
        public System.Data.DataTable GetImgForWhere(string Where)
        {
            ...
            string[] fields = new string[] { "TOP 100  YY_RTU_Basic.STCD, YY_RTU_Basic.NiceName, YY_DATA_IMG.DOWNDATE, YY_DATA_IMG.NFOINDEX, YY_DATA_IMG.DATATYPE,YY_DATA_IMG.TM,YY_DATA_IMG.INFO" };
            return dt.Select(name, fields, Where );
        }
        ...
        #region 得到数据
        /// <summary>
        /// 得到实时前100条数据YY_DATA_AUTO
        /// </summary>
        /// <returns></returns>
        public System.Data.DataTable GetRealTimeData()  //**********
        {
            string name = "(SELECT TOP (100) STCD, ItemID, TM, DOWNDATE, NFOINDEX, DATAVALUE,CorrectionVALUE, DATATYPE FROM  YY_DATA_AUTO ORDER BY TM DESC) AS yda LEFT OUTER JOIN YY_RTU_Basic ON yda.STCD = YY_RTU_Basic.STCD LEFT OUTER JOIN YY_RTU_ITEM ON yda.ItemID = YY_RTU_ITEM.ItemID";
        ...
        {
            string name = "(SELECT  TOP (100) STCD, ItemID, TM, DOWNDATE, NFOINDEX, DATAVALUE,CorrectionVALUE, DATATYPE FROM  YY_DATA_AUTO  " + Where + " ORDER BY TM DESC) AS yda LEFT OUTER JOIN YY_RTU_Basic ON yda.STCD = YY_RTU_Basic.STCD LEFT OUTER JOIN YY_RTU_ITEM ON yda.ItemID = YY_RTU_ITEM.ItemID";
            string[] fields = new string[] { "yda.TM, YY_RTU_Basic.STCD,yda.CorrectionVALUE, YY_RTU_Basic.NiceName, YY_RTU_ITEM.ItemID, YY_RTU_ITEM.ItemName, YY_RTU_ITEM.ItemDecimal,YY_RTU_ITEM.PlusOrMinus, yda.DOWNDATE, yda.NFOINDEX, yda.DATAVALUE, yda.DATATYPE" };
            string where = "order by yda.TM DESC";
            return dt.Select(name, fields, where);
        }
        ...
        {
            string name = "(SELECT TOP (100) STCD, ItemID, TM, DOWNDATE, NFOINDEX, DATAVALUE, DATATYPE FROM YY_DATA_REM " + Where + " ORDER BY TM DESC) AS ydr LEFT OUTER JOIN YY_RTU_ITEM ON ydr.ItemID = YY_RTU_ITEM.ItemID LEFT OUTER JOIN YY_RTU_Basic ON ydr.STCD = YY_RTU_Basic.STCD ";
        ...
        {
            string name = "(SELECT  TOP (100) STCD, ItemID, TM, DOWNDATE, NFOINDEX, DATAVALUE,CorrectionVALUE, DATATYPE FROM  YY_DATA_AUTO  where stcd='" + STCD + "' ORDER BY TM DESC) AS yda LEFT OUTER JOIN YY_RTU_Basic ON yda.STCD = YY_RTU_Basic.STCD LEFT OUTER JOIN YY_RTU_ITEM ON yda.ItemID = YY_RTU_ITEM.ItemID";
            string[] fields = new string[] { "yda.TM, YY_RTU_Basic.STCD,yda.CorrectionVALUE, YY_RTU_Basic.NiceName, YY_RTU_ITEM.ItemID, YY_RTU_ITEM.ItemName, YY_RTU_ITEM.ItemDecimal,YY_RTU_ITEM.PlusOrMinus, yda.DOWNDATE, yda.NFOINDEX, yda.DATAVALUE, yda.DATATYPE" };
            string where = "order by yda.TM DESC"; 
            return dt.Select(name, fields, where);
        }
        ...
        public System.Data.DataTable GetRealTimeData(string STCD, string[] ItemIDs)  //**********
        {
            ...
            string name = "(SELECT  TOP (100) STCD, ItemID, TM, DOWNDATE, NFOINDEX, DATAVALUE,CorrectionVALUE, DATATYPE FROM  YY_DATA_AUTO  where stcd='" + STCD + "' and ItemID in(" + itemids + ") ORDER BY TM DESC) AS yda LEFT OUTER JOIN YY_RTU_Basic ON yda.STCD = YY_RTU_Basic.STCD LEFT OUTER JOIN YY_RTU_ITEM ON yda.ItemID = YY_RTU_ITEM.ItemID";
            string[] fields = new string[] { "yda.TM, YY_RTU_Basic.STCD,yda.CorrectionVALUE, YY_RTU_Basic.NiceName, YY_RTU_ITEM.ItemID, YY_RTU_ITEM.ItemName, YY_RTU_ITEM.ItemDecimal,YY_RTU_ITEM.PlusOrMinus, yda.DOWNDATE, yda.NFOINDEX, yda.DATAVALUE, yda.DATATYPE" };
            string where = "order by yda.TM DESC"; 
            return dt.Select(name, fields, where);
        }
        ...
        public System.Data.DataTable GetRealTimeNewData()
        {
            ...
            //SELECT   ttt.STCD, ttt.ItemID, ttt.TM, YY_DATA_AUTO_1.DOWNDATE, YY_DATA_AUTO_1.NFOINDEX, YY_DATA_AUTO_1.CorrectionVALUE, YY_DATA_AUTO_1.DATAVALUE, YY_DATA_AUTO_1.DATATYPE
            //into #t
            //FROM      (SELECT   STCD, ItemID, MAX(TM) AS TM    FROM      YY_DATA_AUTO  GROUP BY STCD, ItemID) AS ttt LEFT OUTER JOIN
            ...
            //SELECT   YY_RTU_Basic.STCD, t.ItemID, t.TM, t.DOWNDATE, t.NFOINDEX, t.DATATYPE,YY_RTU_Basic.NiceName, YY_RTU_ITEM.ItemName, YY_RTU_ITEM.ItemDecimal
            ...
            //order by YY_RTU_Basic.STCD,t.ItemID
            //drop table #t
        ...
        public System.Data.DataTable GetRealTimeNewData(string[] ItemIDs)
        {
            ...
            string name = "(SELECT   STCD, ItemID, MAX(TM) AS TM    FROM      YY_DATA_AUTO  GROUP BY STCD, ItemID) AS ttt LEFT OUTER JOIN" +
           " YY_DATA_AUTO AS YY_DATA_AUTO_1 ON ttt.STCD = YY_DATA_AUTO_1.STCD AND  ttt.ItemID = YY_DATA_AUTO_1.ItemID AND ttt.TM = YY_DATA_AUTO_1.TM" +
           " SELECT   YY_RTU_Basic.STCD, t.ItemID, t.TM, t.DOWNDATE, t.NFOINDEX,t.CorrectionVALUE, t.DATATYPE,t.STTYPE,YY_RTU_Basic.NiceName, YY_RTU_ITEM.ItemName, YY_RTU_ITEM.ItemDecimal" +
           " FROM #t AS t LEFT OUTER JOIN YY_RTU_ITEM ON t.ItemID = YY_RTU_ITEM.ItemID RIGHT OUTER JOIN YY_RTU_Basic ON t.STCD = YY_RTU_Basic.STCD";
            string[] fields = new string[] {"ttt.STCD, ttt.ItemID, ttt.TM,YY_DATA_AUTO_1.STTYPE, YY_DATA_AUTO_1.DOWNDATE, YY_DATA_AUTO_1.NFOINDEX, YY_DATA_AUTO_1.CorrectionVALUE, YY_DATA_AUTO_1.DATAVALUE, YY_DATA_AUTO_1.DATATYPE "+
            " into #t"};
            string where = " where  t.ItemID in (" + itemids + ")  order by YY_RTU_Basic.STCD,t.ItemID  drop table #t";
            return dt.Select(name, fields, where);

            #region 带STTYPE的script
            //select ttt.STCD, ttt.ItemID, ttt.TM,YY_DATA_AUTO_1.STTYPE, YY_DATA_AUTO_1.DOWNDATE, YY_DATA_AUTO_1.NFOINDEX, YY_DATA_AUTO_1.CorrectionVALUE, YY_DATA_AUTO_1.DATAVALUE, YY_DATA_AUTO_1.DATATYPE  
            //into #t 
            //from (SELECT   STCD, ItemID, MAX(TM) AS TM    FROM      YY_DATA_AUTO  GROUP BY STCD, ItemID) 
            //AS ttt LEFT OUTER JOIN YY_DATA_AUTO AS YY_DATA_AUTO_1 ON ttt.STCD = YY_DATA_AUTO_1.STCD AND  ttt.ItemID = YY_DATA_AUTO_1.ItemID AND ttt.TM = YY_DATA_AUTO_1.TM 
            //SELECT   YY_RTU_Basic.STCD, t.ItemID, t.TM, t.DOWNDATE, t.NFOINDEX,t.CorrectionVALUE, t.DATATYPE,t.STTYPE,YY_RTU_Basic.NiceName, YY_RTU_ITEM.ItemName, YY_RTU_ITEM.ItemDecimal 
            //FROM #t AS t LEFT OUTER JOIN YY_RTU_ITEM ON t.ItemID = YY_RTU_ITEM.ItemID RIGHT OUTER JOIN YY_RTU_Basic ON t.STCD = YY_RTU_Basic.STCD  
            //where  t.ItemID in ('26') 
            //order by YY_RTU_Basic.STCD,t.ItemID  
            //drop table #t
            #endregion
        }
        ...
        public System.Data.DataTable GetRealTimeNewData(string[] ItemIDs,string STTYPE)
        {
           ...
           " FROM #t AS t LEFT OUTER JOIN YY_RTU_ITEM ON t.ItemID = YY_RTU_ITEM.ItemID RIGHT OUTER JOIN YY_RTU_Basic ON t.STCD = YY_RTU_Basic.STCD";
            string[] fields = new string[] {"ttt.STCD, ttt.ItemID, ttt.TM,YY_DATA_AUTO_1.STTYPE, YY_DATA_AUTO_1.DOWNDATE, YY_DATA_AUTO_1.NFOINDEX, YY_DATA_AUTO_1.CorrectionVALUE, YY_DATA_AUTO_1.DATAVALUE, YY_DATA_AUTO_1.DATATYPE "+
            " into #t"};
            string where = " where  t.ItemID in (" + itemids + ") and sttype ='"+STTYPE+"' order by YY_RTU_Basic.STCD,t.ItemID  drop table #t";
            return dt.Select(name, fields, where);
        ...
        public System.Data.DataTable GetCommandState(string Where) 
        {
            ...
            string[] fields = new string[]{"top 100 YY_DATA_COMMAND.*", "YY_RTU_COMMAND.Remark", "YY_RTU_Basic.NiceName"};
            return dt.Select(name ,fields ,Where);
        }
        #endregion
        ...
        public System.Data.DataTable CreateRTUStateDataTable(System.Data.DataTable datatable)
        {
            ...
            for (int i = 0; i < datatable.Rows.Count; i++)
            {
                ...
                if (statedata.Length == DT.Columns.Count -5)
                {
