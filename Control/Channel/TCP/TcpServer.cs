    ...
    public class TcpServer
    {
        ...
        public void Stop()
        {
            if (IsOpen)
            {
                lock (Ts)
                {
                    var temp = from t in Ts where t.TCPSOCKET != null select t;
        ...
        private void OnConnectRequest(IAsyncResult ar)
        {
            ...
            catch (Exception ex)
            {
                ...
                Service.ServiceControl.log.Error(DateTime.Now + "得到连接异常" + listener.ToString() + ex.ToString());
            }
            ...
            {
                Service.ServiceControl.log.Error(DateTime.Now + "得到连接异常" + ex.ToString());
            }
        ...
        private void OnRecievedData(IAsyncResult ar)
        {
            ...
            {
                Service.ServiceControl.log.Error(DateTime.Now + "接收数据异常" + ex.ToString());
            }
