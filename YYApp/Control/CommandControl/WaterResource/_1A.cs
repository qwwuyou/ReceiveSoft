...
{
    public partial class _1A : UserControl, ICommandControl
    {
        public _1A(string[] stcds)
        {
            InitializeComponent();
        ...
        private void dataGridView_Init(string[] stcds)
        {
            ...
            where = where + ") and YY_RTU_CONFIGDATA.ConfigID in ('02') and YY_RTU_CONFIGDATA.ItemID like '0010%' order by YY_RTU_CONFIGDATA.ItemID asc";
        ...
        private void _1A_Load(object sender, EventArgs e)
        {
