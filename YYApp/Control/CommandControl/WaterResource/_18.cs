...
{
    public partial class _18 : UserControl, ICommandControl
    {
        public _18(string[] stcds)
        {
            InitializeComponent();
        ...
        private void dataGridView_Init(string[] stcds)
        {
            ...
            where = where + ") and YY_RTU_CONFIGDATA.ConfigID in ('01','02') and YY_RTU_CONFIGDATA.ItemID in ('0015000001')";
        ...
        public string[] GetCommand(string[] Stcds, string NFOINDEX, out string CommandCode)
        {
            ...
            else
            {
                ...
                if (dataGridView1.Rows.Count != (Stcds.Length * 2))
                {
                    DevComponents.DotNetBar.MessageBoxEx.Show("请确认所选站点已配置上限、下限各配置项！", "[提示]", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return null;
                }
